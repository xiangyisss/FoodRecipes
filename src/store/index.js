...
export default createStore({
  ...
  actions: {
    getData({ commit }, { query, mealtype, cuisine, diettype, allergie }) {
      axios
        .get(
          `https://api.spoonacular.com/recipes/complexSearch?query=${query}&apiKey=376a071d9e3f4a76a57cb68329ff1cff&type=${
            mealtype ?? ""
    ...
    defaultRecipes({ commit }) {
      axios
        .get(
          "https://api.spoonacular.com/recipes/complexSearch?sort=popularity&apiKey=376a071d9e3f4a76a57cb68329ff1cff&number=12"
        )
